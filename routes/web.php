...
/* PDF 2T 2023 */
Route::get('/descargar-pdf22023', function() {
    $file = public_path()."/file/reporte22023.pdf";

    $headers = array(
        'Content-Type: application/pdf',
    );
    return Response::download($file, "Progreso Cierre Brechas AIO - Reporte 2T 2023.pdf", $headers);
});
/* EXCEL */
/* Excel 2T 2022 */
